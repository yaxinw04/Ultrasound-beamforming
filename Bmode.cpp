...
int main(){
    ...
    BmodeClass *scanlineHead = new BmodeClass(parameters, dataHead, 0); // this is head
    scanlineHead->next = NULL;

    // ASSIGNMENT 4 PART 5 BEGIN: TO BE COMPLETED BY STUDENTS
    BmodeClass *currentScanline = scanlineHead; // pointer used to keep track of which object is the current scanline
